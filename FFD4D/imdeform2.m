function [image1,dgridx1,dgridy1,dgridx2,dgridy2,dgridx3,dgridy3] = imdeform2(density,image1,image2)
...
%     for n = 1:N
        ...
        [dgridx1,dgridy1] = amvd(density,dgridx1,dgridy1);
...
%     for n = 1:N
        ...
        [dgridx2,dgridy2] = amvd(density,dgridx2,dgridy2);
...
%     for n = 1:N
        ...
        [dgridx3,dgridy3] = amvd(density,dgridx3,dgridy3);
